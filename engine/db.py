...
# query = "INSERT INTO sys_command VALUES (null,'control panel', 'C:\\Users\\SAINATH\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs\\System Tools\\Control Panel')"
# cursor.execute(query)
# con.commit()
